...
export const cases = [
  {
    ...
    summary:
      "Founding Head of UX at a stealth cybersecurity startup, co-created investor-facing POCs that helped secure an eight-figure seed round, built a 4-designer team, and embedded AI into the design-to-dev workflow.",
    cardRole: "Head of UX (Founding), helped secure an eight-figure seed round.",
    lead:
      "As the founding Head of UX at a stealth-mode cybersecurity startup, I'm building the design function from scratch, shaping the product narrative that helped close an eight-figure seed round, and embedding AI into how my team designs and ships.",
    meta: [
      ["Role", "Head of UX (Founding)"],
    ...
    stats: [
      { num: "8-fig.", label: "Seed round shaped by investor-facing POCs" },
      { num: "12", label: "Design partners co-creating POCs" },
      { num: "4", label: "Designers hired to run parallel tracks" },
      { num: "7-fig.", label: "ARR targeted this year" },
    ],
    sections: [
      { h2: "At a glance" },
      ...
      { note: "I'm light on screens and company specifics in this write-up since we're still in stealth, but the process, the decisions, and the numbers below are exactly how it played out." },
      {
        atGlance: [
          ...
          {
            n: "Approach",
            title: "Co-create with design partners, then build the org to outlast it",
            p: "I pressure-tested every concept against 12 real design partners' workflows, hired a 4-designer team fast enough to run those tracks in parallel, and structured the design org into three verticals, research, product, and business design, so it could mature alongside the company.",
          },
          {
            n: "Impact",
            title: "A seed round closed, an org and company built to outlast it",
            p: "Those investor-facing POCs directly contributed to closing our eight-figure seed round. The company has since grown to 80+ employees globally, and the three-vertical design org I built has the platform on track to hit a seven-figure ARR target this year.",
          },
        ],
      },
      { h2: "The opportunity" },
      ...
      { p: "We tested that bet before we had a sales team or a GA product. I co-created proof-of-concepts with <strong>12 design partners</strong>, pressure-testing our earliest concepts against their real workflows and threat models. Those POCs became the centerpiece of our investor narrative and were a direct contributor to closing our <strong>eight-figure seed round</strong>." },
...

  {
    ...
    sections: [
      ...
      { note: "We're still seed-stage and in stealth, so I'm light on screens and specifics here too; the system, the numbers, and the MCP server are exactly how it played out." },
      {
        atGlance: [
          ...
          },
          {
            ...
            p: "Most prototyping no longer routes through design and UI at all. That speed held up well enough to help close our eight-figure seed round, and it's reshaping what I think a design system is actually for.",
          },
        ],
      },
      ...
      { p: "This system exists for a wider, more mixed group: AI agents reading tokens directly, and PMs, engineers, and founders who don't have a design background but need a credible interface fast. I built for both on purpose, not as one blurred audience." },
      {
        compare: {
          ...
          rows: [
            ...
            ["What proved it worked", "34 people building on it, $1.5M in tracked savings, an ROI slide leadership trusted.", "Design-partner POCs that held up fast enough to help close an eight-figure seed round."],
          ],
        },
      },
      { h2: "The bottleneck" },
      ...
      { h2: "Early impact" },
      { p: "We're still stealth, but the pattern holds: the product trio prototypes and validates with design partners at sprint speed without losing the quality bar once things ship, the same speed and rigor that helped this round of POCs contribute to closing our eight-figure seed round." },
...

  {
    ...
    sections: [
      ...
      { p: "Lean UX and a team that owned the outcome together made Cloud Cost Management a real differentiator for Harness in DevOps, not a feature checkbox next to competitors' tools." },
      { ul: [
